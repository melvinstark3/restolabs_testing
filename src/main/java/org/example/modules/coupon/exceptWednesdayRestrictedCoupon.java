...
public class exceptWednesdayRestrictedCoupon extends browserSetup {
    public exceptWednesdayRestrictedCoupon() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@data-testid=\"EXCEPTWEDNESDAYRESTRICTEDCOUPON\"]"))).click();
