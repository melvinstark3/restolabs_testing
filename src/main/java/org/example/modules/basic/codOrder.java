...
public class codOrder extends browserSetup {
    public codOrder() throws InterruptedException {
        ...
        try {
            ...
            System.out.println("CASE 8: PASS: Place " + readProperty("codOrderTime") + " Order");
            ...
            System.out.println("CASE 8: FAIL: " + readProperty("codOrderTime") + " Order wasn't Posted in Time");
