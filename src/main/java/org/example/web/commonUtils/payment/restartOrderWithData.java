...
public class restartOrderWithData extends browserSetup{
    ...
    public restartOrderWithData(boolean loggedIn) throws InterruptedException {
        ...
        secondNewCardPayment secondNewCardPayment = getModule.currentModuleClass("secondNewCardPayment",org.example.web.commonUtils.payment.secondNewCardPayment.class);
